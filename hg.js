      ...
      <div class="p-2 d-flex justify-content-between align-items-center cardTitle">
        ...
        <i class="fa-regular fa-circle-xmark pb-2 text-danger" style="font-size:1.5rem"></i>
           ...
           <div class="d-flex align-items-center justify-content-center">
                <p class="display-6 text-center text-danger">${Math.round(
                  data.main.temp
                )}°C</p>
                <img class="mb-3 ms-3" src="${
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><b>Wind Speed: </b> ${
              data.wind.speed
            } </li>
            <li class="list-group-item"><b>Humidity: </b> ${
              data.main.humidity
            }</li>
            <li class="list-group-item"><b>Temp Min-Max: </b> ${
              data.main.temp_min
            } - ${data.main.temp_max}</li>
            ${
              data.main.sea_level == undefined
                ? ""
                : `<li class="list-group-item"><b>Sea Level: </b> ${data.main.sea_level}</li>`
            }
        </ul>
    </div>
    </div>
